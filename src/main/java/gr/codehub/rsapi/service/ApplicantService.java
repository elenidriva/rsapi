...
public interface ApplicantService {
     ...
     */
    boolean setApplicantInactive(int applicantIndex) throws BusinessException, ApplicantIsInactive;
     ...
     */
    Applicant updateApplicant(ApplicantDto applicantDto, int applicantIndex) throws BusinessException, ApplicantUpdateException;
